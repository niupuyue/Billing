...
# 将下面替换成自己的实体类
-keep class com.xizhi_ai.commonlib.dto.** { *; }
-keep class com.xizhi_ai.commonlib.dto.request.** { *; }
-keep class com.xizhi_ai.commonlib.bean.** { *; }
#-keep class com.xizhi_ai.commonlib.event.** { *; }
...
#-keep class cc.ibooker.richtext.RichBean {*;}
-keep class **.dao.**{*;}
-keep class **.data.**{*;}
-keep class **.bean.**{*;}
-keep class **.dto.**{*;}
-keep class **.source.**{*;}
-keep class com.paulniu.bill_data_lib.*